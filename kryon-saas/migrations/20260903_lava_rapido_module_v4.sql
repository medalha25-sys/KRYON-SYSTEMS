-- ==============================================================================
-- KRYON SYSTEMS — ETAPA 3: MIGRACÃO PILOTO KRYON LAVA RÁPIDO (VERSÃO 4 HARDENED)
-- DATA: 03/09/2026
-- MODO: NÃO-DESTRUTIVO / IDEMPOTENTE / ISOLAMENTO ZERO-TRUST / MENOR PRIVILÉGIO
-- ==============================================================================
...
-- 1. Ativação de Assinatura com Verificação Estrita de Autorização
