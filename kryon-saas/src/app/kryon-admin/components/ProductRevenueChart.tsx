...
import { PieChart, Layers, ArrowUpRight } from 'lucide-react'
import { mockProductRevenue } from '../mock-data'

export function ProductRevenueChart() {
  const totalRevenue = mockProductRevenue.reduce((acc, p) => acc + p.revenue, 0)
    ...
    <section className="p-5 sm:p-6 rounded-3xl bg-[#0B0F19] border border-white/[0.08] relative overflow-hidden shadow-xl shadow-black/40 space-y-5">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between text-[11px] text-slate-500 font-medium">
          <span>0%</span>
          <span>100% da Receita Gerada</span>
        </div>
      </div>
          ...
          >
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11px] text-slate-400 font-semibold">{item.percentage}% do total</p>
              </div>
            </div>
