...
-- 4. Policies (Re-runnable)
DROP POLICY IF EXISTS "Super Admins can view stats" ON public.org_daily_stats;
...
DROP POLICY IF EXISTS "Super Admins can view health scores" ON public.health_scores;
