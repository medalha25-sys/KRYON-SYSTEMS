...
const PainPoints = () => {
    return (
        <section className="section py-12 sm:py-16 md:py-24 bg-[#050507] relative overflow-hidden">
            {/* Background Accent Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[300px] sm:h-[400px] bg-red-600/[0.03] rounded-full blur-[100px] sm:blur-[140px] pointer-events-none" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
                    {problems.map((item, index) => (
                        <motion.div
                            ...
                            className="relative flex flex-col justify-start overflow-hidden rounded-2xl p-5 sm:p-7 bg-red-500/[0.03] border border-red-500/10 hover:border-red-500/30 transition-all hover:-translate-y-1"
                        >
                            {/* Left Red Accent Bar */}
                            ...
                            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl flex items-center justify-center bg-red-500/10 text-red-400 border border-red-500/20 mb-4 sm:mb-6 flex-shrink-0">
                                {item.icon}
                            </div>
