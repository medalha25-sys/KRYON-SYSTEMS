...
export default async function ConcreteLayout({
  ...
  // 1. Fetch Profile for Context/Sidebar
  ...
  // 2. Access Assumption (Definitive Fix)
  // MISSION: Assume access already validated by Isolated Login or Middleware.
  if (!isSuperAdmin && !profile?.organization_id) {
      redirect('/login?message=Organização não identificada.')
  }
